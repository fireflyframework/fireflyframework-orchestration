...
/**
 * Default compensation error handler that always returns {@link CompensationErrorResult#CONTINUE}.
 * This matches the historical behavior where compensation errors are swallowed
 * and subsequent compensation steps proceed.
 */
