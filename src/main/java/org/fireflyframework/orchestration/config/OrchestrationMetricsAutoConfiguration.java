...
@ConditionalOnProperty(name = "firefly.orchestration.metrics.enabled", havingValue = "true", matchIfMissing = true)
public class OrchestrationMetricsAutoConfiguration {
